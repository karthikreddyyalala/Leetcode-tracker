...
export function HistoryPage({ problems, onReview, onDelete }: Props) {
  ...
  return (
    <div className="mx-auto max-w-4xl px-5 py-8">
      <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-[2fr_1fr]">
        <div>
        ...
        <div className="mb-5 flex items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-zinc-800 bg-zinc-900 py-2 pl-8 pr-3 text-sm text-zinc-100 placeholder-zinc-600 outline-none transition-base focus:border-sky-500/50 focus:ring-1 focus:ring-sky-500/20"
            />
          </div>
